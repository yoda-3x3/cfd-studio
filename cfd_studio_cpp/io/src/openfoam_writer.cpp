...
void OpenFoamCaseWriter::write_system_stubs() const {
    ...
    write_foam_file((system / "controlDict").string(), "dictionary", "controlDict",
        "application     venturiCFD;\nstartFrom       startTime;\nstartTime       0;\n"
        "stopAt          endTime;\nendTime         1;\ndeltaT          1;\nwriteControl    timeStep;\n"
        "writeInterval   1;\n");
    write_foam_file((system / "fvSchemes").string(), "dictionary", "fvSchemes", "// generated by Venturi CFD\n");
    write_foam_file((system / "fvSolution").string(), "dictionary", "fvSolution", "// generated by Venturi CFD\n");
}
